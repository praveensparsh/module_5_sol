...
showLoading("#main-content");
  $ajaxUtils.sendGetRequest(allCategoriesUrl,manipulatedCatData,true); 
// Explicitely setting the flag to get JSON from server processed into an object literal
});
// *** finish **

function manipulatedCatData(responseText){
...
function buildAndShowHomeHTML (categories) {
  ...
  $ajaxUtils.sendGetRequest(
    ...
    function (homeHtml) {
      ...
      var randCategoryObj = chooseRandomCategory(categories);
      
      var randomCategoryShortName = "'"+randCategoryObj['short_name']+"'"; 
